...
router.get('/orders', auth(USER_ROLE.customer), OrderController.getAllOrders);
router.put('/profile/:userId',validateRequest(AuthValidation.updateUserValidationSchema), OrderController.updateProfile);
